...
public class ItemLevel1 extends AbstractExpandableItem<ItemLevel2> implements MultiItemEntity {
    ...
    private List<ItemLevel2> children;
    ...
    public List<ItemLevel2> getChildren() {
        return children;
    }

    public void setChildren(List<ItemLevel2> children) {
