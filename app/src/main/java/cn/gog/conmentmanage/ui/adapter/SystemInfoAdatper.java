 ...
 * 创建人： gujin
 */
public class SystemInfoAdatper extends BaseQuickAdapter<SystemInfoPage.ListBean,BaseViewHolder> {
   ...
   private boolean isEdit  = false;
    ...
    public SystemInfoAdatper(Context context, @Nullable List<SystemInfoPage.ListBean> data) {
        super(R.layout.item_duty_layout, data);
        this.mContext = context;
    }

    @Override
    protected void convert(BaseViewHolder helper, SystemInfoPage.ListBean item) {
