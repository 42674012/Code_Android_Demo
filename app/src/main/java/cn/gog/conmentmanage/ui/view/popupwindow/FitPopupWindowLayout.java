...
public class FitPopupWindowLayout extends RelativeLayout {
    ...
    public static final int SHARP_WIDTH = DensityUtils.dp2px(20);
    public static final int SHARP_HEIGHT = (int) (SHARP_WIDTH * 1.0f);
    private static final int RECT_CORNER = DensityUtils.dp2px(12);

    private int mXoffset = DensityUtils.dp2px(12);
    ...
    private Path makeSharpPath() {
        ...
        mSharpPath.cubicTo(mXoffset, getMeasuredHeight(),
                mXoffset, getMeasuredHeight() - SHARP_HEIGHT,
