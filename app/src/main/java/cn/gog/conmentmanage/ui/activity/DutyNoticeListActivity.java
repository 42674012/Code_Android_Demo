...
import cn.gog.conmentmanage.view.IDutyInfoView;
import cn.gog.conmentmanage.view.IDutyView;
import common.utils.StatusBarCompat;

public class DutyNoticeListActivity extends BaseMvpActivity<DutyPresent> implements IDutyView {
    ...
    DutyAdatper adapter;
    private List<TaskPage.ListBean> mData;
    ...
    @Override
    protected DutyPresent createPresenter() {
        return new DutyPresent(this);
    }
    ...
    protected void refreshData() {
        page = 1;
        showLoadingDialog();
        createPresenter().pageTaskMsg(page,10);
    }
    ...
    protected void bindViews() {
        ...
        adapter = new DutyAdatper(this, mData);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
              ...
              switch (view.getId()){
                  ...
                  Intent mIntent = new Intent(DutyNoticeListActivity.this, DutyDetailActivity.class);
    ...
    @Override
    public void TaskPageSuccess(TaskPage data) {
        hideLoadingDialog();
    ...
    public void click(View view){
        switch (view.getId()){
            ...
            case R.id.delete_tv:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DutyNoticeListActivity.this);
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        ...
                        for(TaskPage.ListBean bena :mData){
                            if(bena.isChosen()){
            ...
            case R.id.delete_all:
                AlertDialog.Builder builder1 = new AlertDialog.Builder(DutyNoticeListActivity.this);
