...
/**
 * Created by Chenyx on 2017/7/31.
 */
...
public final class HttpDownloader implements Downloader {
     ...
     * cache directory.
     */
    public HttpDownloader(final Context context) {
     ...
     */
    public HttpDownloader(final File cacheDir) {
     ...
     */
    public HttpDownloader(final Context context, final long maxSize) {
     ...
     * @param maxSize  The size limit for the cache.
     */
    public HttpDownloader(final File cacheDir, final long maxSize) {
     ...
     */
    public HttpDownloader(OkHttpClient client) {
        this.client = client;
     ...
     */
    public HttpDownloader(Call.Factory client) {
        this.client = client;
        this.cache = null;
    }
